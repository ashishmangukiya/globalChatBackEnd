                        ...
                        newUser.save((err, newUser) => {
                            if (err) {
                                ...
                                let sendEmailOptions = {
                                    ...
                                    subject: 'Welcome to global Chat ',
                                    html: `<b> Dear ${newUserObj.firstName}</b><br> Hope you are doing well. 
                                    <br>Welcome to our Global Chat a brand new chat application for our admirable Employees.<br>
                                    
                                    <b>CEO,Global Chat <br>
                                    Ashish mangukiya</b>
                                    `
                                }
            ...
            UserModel.update({ 'email': req.body.email }, options).exec((err, result) => {
                if (err) {
                    ...
                    let sendEmailOptions = {
                        ...
                        subject: 'Reset Password for Global Chat ',
                        html: `<h4> Hi ${userDetails.firstName}</h4>
                            <p>
                                We got a request to reset your Global Chat password associated with this ${req.body.email} Email. <br>
        ...
        return new Promise((resolve, reject) => {
            ...
            UserModel.update({ 'userId': userDetails.userId }, options).exec((err, result) => {
                if (err) {
                    ...
                    let sendEmailOptions = {
                        email: userDetails.email,
                        subject: 'Password Updated for Global Chat ',
                        html: `<h4> Hi ${userDetails.firstName}</h4>
                        <p>
                            Password updated successfully.
                        </p>
                        <h3> Thanks for using global Chat </h3>
                        global Chat  
                        <br><b>Ashish mangukiya</b>
                                    `
                    }
